...
public class MoneyToWord {
    ...
    public String convert(String nameCurrency, Double money) {
        StringBuilder result = new StringBuilder();
        CurrenciesEnum currenciesEnum = CurrenciesEnum.valueOf(nameCurrency);

        Long longPart = money.longValue();
        result.append(longToString(longPart));
        result.append(currenciesEnum.getCurrencyPartString(currenciesEnum,0, longPart));
        clearSum();
        Long coinsPart = Math.round((money - longPart) * 100);
        result.append(longToString(coinsPart));
        result.append(currenciesEnum.getCurrencyPartString(currenciesEnum,1, coinsPart));
